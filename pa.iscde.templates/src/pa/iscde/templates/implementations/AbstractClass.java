...
public class AbstractClass implements Iimplement{
	...
	/**
	 * Constructor para criação da class abstracta que recebe como parametro a class alvo.
	 * @param target
	 */
	...
	/**
	 * @return Devolve a class abstracta que possui os metodos a ser implementados.
	 */
	@Override
